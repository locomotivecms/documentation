...
* Rails 4.2.x!
* brand new content editing experience. AlohaEditor and TinyMCE were dropped and replaced by [Wysihtml](http://wysihtml.com) with a new system to edit the content and see the changes live.
* new caching system.
...
* the page rendering engine has been extracted to its own gem: [Steam](http://github.com/locomotivecms/steam). Both Wagon and Engine use Steam.
