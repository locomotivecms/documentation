...
| label_field_name | String | Field slug. Default field slug (generally title), it must be a string field. |
...
| text | Longer field.\ Use with the **text_formatting** option: * html: option to display a wysiwyg editor in the backoffice * markdown |
