...
| **Type** | A |
| **Name** | *(leave it blank)* |
| **Address** | 35.196.41.30 |


**Note**: `35.196.41.30` is the IP address of the **locomotive.works** platform.
...
More explanation [here](https://cybernews.com/resources/web-hosting-glossary/#dns)
{% endhint %}
