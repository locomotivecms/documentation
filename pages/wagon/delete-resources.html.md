...
```shell
wagon delete ENV RESOURCE [SLUG] [PATH]
```
...
```shell
wagon delete staging page about-us
```

```shell
wagon delete staging content_type articles
```

```shell
wagon delete live translations
```

```shell
wagon delete staging site
```
